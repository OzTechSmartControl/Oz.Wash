...
export default function CourtesyView({ supabase, T: propT }) {
    ...
    return (
      <div
        ...
        style={{
          ...
          padding: "1.1rem 1.25rem", flex: 1, minWidth: 120,
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 6, position: "relative" }}>
          ...
          {Icon && (
            <div style={{ background: c + "18", borderRadius: 10, padding: 9, border: `1px solid ${c}22`, flexShrink: 0 }}>
  ...
  const grant = async () => {
    ...
    try {
      ...
      const redirectTo = `https://ozwash.vercel.app/?courtesy=true`;
