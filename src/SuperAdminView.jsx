...
export default function SuperAdminView({
  ...
  const sidebarContent = (
    ...
    >
          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = `<span style="font-family:'Bebas Neue',sans-serif;font-size:16px;letter-spacing:1px;color:#4db8ff">OZ</span>`;
              }}
            />
          </div>
          <div>
      ...
      {/* ── Footer ── */}
      <div
        style={{ padding: '1rem 1.25rem', borderTop: `1px solid ${T.border}` }}
      >
        {/* Theme toggle */}
        {onToggleTheme && (
          <div
  ...
  const renderView = () => {
    switch (activeView) {
      ...
      case 'clients':
        return <ClientsView {...sharedProps} />;
      case 'subscriptions':
        return <SubscriptionsView {...sharedProps} />;
      case 'finance':
        return <FinanceView {...sharedProps} />;
      case 'courtesy':
        return <CourtesyView {...sharedProps} />;
      case 'alerts':
        return <AlertsView {...sharedProps} />;
      case 'analytics':
        return <AnalyticsView {...sharedProps} />;
      default:
        return <DashboardView {...sharedProps} />;
    }
  };
